...
const AddExperienceForm = ({addExperience, history}) => {
    ...
    const [toDateDisabled, setDateDisable] = useState(false)
    ...
    return (
      ...
      <form class="form" onSubmit = {e => onSubmit(e)}>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <p><input type="checkbox" name="current" value="" onChange = {e => {setFormData({...formData, current: !current});
            setDateDisable(!toDateDisabled);
